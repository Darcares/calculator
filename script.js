...
function initializeCalculator() {
  ...
  operators.forEach((operator) =>
    operator.addEventListener(`click`, (event) =>
      assignElements(event, screen, operation, permit)
    )
  );
  ...
  document.addEventListener(`keydown`, (event) =>
    readKeyboard(event, screen, operation, permit)
  );
}
...
function Permit(
  isCleanScreenActive,
  canBeSecondOperatorAssigned,
  isEraseElementEnabled
) {
